...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var threeNumber = sum(a, sum(b,c)[0])[0];

  var oneSum = sum(a, b)[0]; 
  var twoSum = sum(c, oneSum)[0];

  var multiplyNum = multiply(a, multiply(b,c)[0])[0];

  var returnOne = a + ' and ' + b + ' and ' + c + ' sum to ' + threeNumber + '.';
  var returnTwo = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiplyNum + '.';
 
  return [threeNumber, multiplyNum, returnOne, returnTwo];
}
...
function multiplyArray(multiArray){ //eslint-disable-line
  var theSum = multiply(multiArray[0], multiply(multiArray[1], multiArray[2])[0])[0];
  
  // var multiOne = multiply(multiArray[0], multiArray[1]);
  // multiOne = multiOne[0];
  // var multiTwo = multiply(multiplyArray[2], multiOne);
  // multiTwo = multiTwo[0];
 
  var message = 'The numbers ' + multiArray + ' have a product of ' + theSum + '.';
  return [theSum, message];
